...
To use a profile's isolated Claude session directory in manual wiring, pass
the profile explicitly:

```bash
copillm env claude --profile personal
```
